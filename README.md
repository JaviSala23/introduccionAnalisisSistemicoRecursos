...
- `Clase1/` y `Clase2/`: Carpeta con actividades y materiales específicos de cada clase.
- `libros/`: Espacio para libros y bibliografía recomendada.
- `Recursos.md`: Enlaces y recursos complementarios (audios, esquemas visuales, etc.).
- `README.md`: Este archivo, con la descripción general y guía de uso.
